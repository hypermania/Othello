...
inline double evaluate(BitState *state){
  ...
  score += row_1[offset_6561[e_w_r1] + _pext_u32(e_b_r1, ~e_w_r1)];
  score += row_2[offset_6561[e_w_r2] + _pext_u32(e_b_r2, ~e_w_r2)];
  score += row_3[offset_6561[e_w_r3] + _pext_u32(e_b_r3, ~e_w_r3)];
  score += row_4[offset_6561[e_w_r4] + _pext_u32(e_b_r4, ~e_w_r4)];
  score += row_4[offset_6561[e_w_r5] + _pext_u32(e_b_r5, ~e_w_r5)];
  score += row_3[offset_6561[e_w_r6] + _pext_u32(e_b_r6, ~e_w_r6)];
  score += row_2[offset_6561[e_w_r7] + _pext_u32(e_b_r7, ~e_w_r7)];
  score += row_1[offset_6561[e_w_r8] + _pext_u32(e_b_r8, ~e_w_r8)];
  ...
  score += row_1[offset_6561[sr_w_r1] + _pext_u32(sr_b_r1, ~sr_w_r1)];
  score += row_2[offset_6561[sr_w_r2] + _pext_u32(sr_b_r2, ~sr_w_r2)];
  score += row_3[offset_6561[sr_w_r3] + _pext_u32(sr_b_r3, ~sr_w_r3)];
  score += row_4[offset_6561[sr_w_r4] + _pext_u32(sr_b_r4, ~sr_w_r4)];
  score += row_4[offset_6561[sr_w_r5] + _pext_u32(sr_b_r5, ~sr_w_r5)];
  score += row_3[offset_6561[sr_w_r6] + _pext_u32(sr_b_r6, ~sr_w_r6)];
  score += row_2[offset_6561[sr_w_r7] + _pext_u32(sr_b_r7, ~sr_w_r7)];
  score += row_1[offset_6561[sr_w_r8] + _pext_u32(sr_b_r8, ~sr_w_r8)];
  ...
  score += diag_8[offset_6561[e_w_d_A1] + _pext_u32(e_b_d_A1, ~e_w_d_A1)];
  score += diag_7[offset_2187[e_w_d_B1] + _pext_u32(e_b_d_B1, ~e_w_d_B1)];
  score += diag_7[offset_2187[e_w_d_A2] + _pext_u32(e_b_d_A2, ~e_w_d_A2)];
  score += diag_6[offset_729[e_w_d_C1] + _pext_u32(e_b_d_C1, ~e_w_d_C1)];
  score += diag_6[offset_729[e_w_d_A3] + _pext_u32(e_b_d_A3, ~e_w_d_A3)];
  score += diag_5[offset_243[e_w_d_D1] + _pext_u32(e_b_d_D1, ~e_w_d_D1)];
  score += diag_5[offset_243[e_w_d_A4] + _pext_u32(e_b_d_A4, ~e_w_d_A4)];
  score += diag_4[offset_81[e_w_d_E1] + _pext_u32(e_b_d_E1, ~e_w_d_E1)];
  score += diag_4[offset_81[e_w_d_A5] + _pext_u32(e_b_d_A5, ~e_w_d_A5)];
  ...
  score += diag_8[offset_6561[s_w_d_A1] + _pext_u32(s_b_d_A1, ~s_w_d_A1)];
  score += diag_7[offset_2187[s_w_d_B1] + _pext_u32(s_b_d_B1, ~s_w_d_B1)];
  score += diag_7[offset_2187[s_w_d_A2] + _pext_u32(s_b_d_A2, ~s_w_d_A2)];
  score += diag_6[offset_729[s_w_d_C1] + _pext_u32(s_b_d_C1, ~s_w_d_C1)];
  score += diag_6[offset_729[s_w_d_A3] + _pext_u32(s_b_d_A3, ~s_w_d_A3)];
  score += diag_5[offset_243[s_w_d_D1] + _pext_u32(s_b_d_D1, ~s_w_d_D1)];
  score += diag_5[offset_243[s_w_d_A4] + _pext_u32(s_b_d_A4, ~s_w_d_A4)];
  score += diag_4[offset_81[s_w_d_E1] + _pext_u32(s_b_d_E1, ~s_w_d_E1)];
  score += diag_4[offset_81[s_w_d_A5] + _pext_u32(s_b_d_A5, ~s_w_d_A5)];
  ...
  score += corner_33[offset_19683[e_w_c33] + _pext_u32(e_b_c33, ~e_w_c33)];
  score += corner_33[offset_19683[r_w_c33] + _pext_u32(r_b_c33, ~r_w_c33)];
  score += corner_33[offset_19683[r2_w_c33] + _pext_u32(r2_b_c33, ~r2_w_c33)];
  score += corner_33[offset_19683[r3_w_c33] + _pext_u32(r3_b_c33, ~r3_w_c33)];
  ...
  score += corner_25[offset_59049[e_w_c25] + _pext_u32(e_b_c25, ~e_w_c25)];
  score += corner_25[offset_59049[r_w_c25] + _pext_u32(r_b_c25, ~r_w_c25)];
  score += corner_25[offset_59049[r2_w_c25] + _pext_u32(r2_b_c25, ~r2_w_c25)];
  score += corner_25[offset_59049[r3_w_c25] + _pext_u32(r3_b_c25, ~r3_w_c25)];
  score += corner_25[offset_59049[s_w_c25] + _pext_u32(s_b_c25, ~s_w_c25)];
  score += corner_25[offset_59049[sr_w_c25] + _pext_u32(sr_b_c25, ~sr_w_c25)];
  score += corner_25[offset_59049[sr2_w_c25] + _pext_u32(sr2_b_c25, ~sr2_w_c25)];
  score += corner_25[offset_59049[sr3_w_c25] + _pext_u32(sr3_b_c25, ~sr3_w_c25)];
  ...
  score += edge_xx[offset_59049[e_w_xx] + _pext_u32(e_b_xx, ~e_w_xx)];
  score += edge_xx[offset_59049[r_w_xx] + _pext_u32(r_b_xx, ~r_w_xx)];
  score += edge_xx[offset_59049[r2_w_xx] + _pext_u32(r2_b_xx, ~r2_w_xx)];
  score += edge_xx[offset_59049[r3_w_xx] + _pext_u32(r3_b_xx, ~r3_w_xx)];
